...
class BaseXConnector:
    ...
    def execute_query(self, query: str) -> str:
        ...
        Raises:
            DatabaseError: If the query failed or the connector is not connected.
        """
        if not self.is_connected():
            raise DatabaseError("Not connected to BaseX server")
    ...
    def execute_update(self, query: str) -> str:
        """
        Execute an XQuery update.
        
        Args:
            query: XQuery update string.
            
        Returns:
            Update result as a string.
            
        Raises:
            DatabaseError: If the update failed or the connector is not connected.
        """
        if not self.is_connected():
            raise DatabaseError("Not connected to BaseX server")
