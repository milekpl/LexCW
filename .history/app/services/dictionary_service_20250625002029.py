...
class DictionaryService:
    ...
    def get_entry(self, entry_id: str) -> Entry:
        ...
        try:
            query = f"""
            for $entry in /*[local-name()='lift']/*[local-name()='entry'][@id="{entry_id}"]
            return $entry
            """
    ...
    def create_entry(self, entry: Entry) -> str:
        ...
        try:
            ...
            entry_element = re.search(r'<(?:lift:)?entry.*?</(?:lift:)?entry>', entry_xml, re.DOTALL)
            ...
            query = f"""
            insert node {entry_xml} into /*[local-name()='lift']
            """
    ...
    def update_entry(self, entry: Entry) -> None:
        ...
        try:
            ...
            query = f"""
            replace node /*[local-name()='lift']/*[local-name()='entry'][@id="{entry.id}"] with {entry_xml}
            """
    ...
    def delete_entry(self, entry_id: str) -> None:
        ...
        try:
            ...
            query = f"""
            delete node /*[local-name()='lift']/*[local-name()='entry'][@id="{entry_id}"]
            """
    ...
    def list_entries(self, limit: Optional[int] = None, offset: int = 0, sort_by: str = "lexical_unit") -> Tuple[List[Entry], int]:
        ...
        try:
            # Get total count
            count_query = "count(//*[local-name()='entry'])"
            ...
            # List entries
            query = f"""
            (for $entry in /*[local-name()='lift']/*[local-name()='entry']
            order by {sort_expr}
    ...
    def search_entries(self, 
        ...
        try:
            ...
            # Get total count
            count_query = f"""
            count(for $entry in /*[local-name()='lift']/*[local-name()='entry']
    ...
    def get_related_entries(self, entry_id: str, relation_type: Optional[str] = None) -> List[Entry]:
        ...
        try:
            ...
            # Get related entries
            query = f"""
            let $entry_relations := /*[local-name()='lift']/*[local-name()='entry'][@id="{entry_id}"]/relation[{relation_condition}]/@ref
    ...
    def get_entries_by_grammatical_info(self, grammatical_info: str) -> List[Entry]:
        ...
        try:
            query = f"""
            for $entry in /*[local-name()='lift']/*[local-name()='entry'][grammatical-info/@value="{grammatical_info}"]
            return $entry
            """
