...
class DictionaryService:
    ...
    def search_entries(self, 
        ...
        try:
            ...
            # Build a simpler query with proper FLWOR structure
            count_query = f"""
            xquery 
            let $entries := 
            ...
            # Simplify the query to avoid any XQuery syntax issues
            query_str = f"""
            xquery 
            ...
            self.logger.debug("Executing search query: %s", query_str)
