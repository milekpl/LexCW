...
class TestDictionaryService:
    ...
    def test_create_entry(self, dict_service):
        ...
        assert retrieved_entry.lexical_unit == "new test"
    ...
    def test_update_entry(self, dict_service):
        ...
        # Modify it
        entry.lexical_unit = "modified test"
        ...
        assert updated_entry.lexical_unit == "modified test"
