...
class TestLiveSearchFunctionality(unittest.TestCase):
    ...
    def test_basic_search(self):
        ...
        try:
            ...
            entries, total = self.service.search_entries(query, limit=10)  # Explicitly set limit to 10
            ...
            self.assertLessEqual(len(entries), 10, "Number of entries should not exceed the limit")
    ...
    def test_search_edge_cases(self):
        ...
        try:
            ...
            # Query with quotes and special characters - use a safer example
