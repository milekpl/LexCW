...
class TestDictionaryStatistics:
    ...
    def test_count_senses_and_examples(self, dict_service):
        ...
        assert new_sense_count <= sense_count, f"Expected sense count not to increase from {sense_count}, got {new_sense_count}"
        assert new_example_count <= example_count, f"Expected example count not to increase from {example_count}, got {new_example_count}"
