...
class TestDictionaryServiceFilteringSorting:
    ...
    def test_list_entries_with_sort_order_asc(self) -> None:
        ...
        with patch.object(service, 'count_entries', return_value=2), \
            ...
            mock_parse.return_value = [
                Entry(id_="entry1", lexical_unit={"en": "apple"}, senses=[Sense(id="sense_1", definitions={"en": {"text": "a fruit"}})]),
                Entry(id_="entry2", lexical_unit={"en": "banana"}, senses=[Sense(id="sense_1", definitions={"en": {"text": "another fruit"}})])
            ]
            entries, total = service.list_entries(limit=10, offset=0, sort_by="lexical_unit", sort_order="asc")
    ...
    def test_list_entries_with_sort_order_desc(self) -> None:
        ...
        with patch.object(service, 'count_entries', return_value=2), \
            ...
            entries, total = service.list_entries(limit=10, offset=0, sort_by="lexical_unit", sort_order="desc")
            assert len(entries) == 2
            assert total == 2
    ...
    def test_list_entries_with_filter_text(self) -> None:
        ...
        with patch.object(service, '_count_entries_with_filter', return_value=1), \
            ...
            entries, total = service.list_entries(limit=10, offset=0, sort_by="lexical_unit", sort_order="asc", filter_text="app")
    ...
    def test_list_entries_with_combined_filter_and_sort(self) -> None:
        ...
        with patch.object(service, '_count_entries_with_filter', return_value=2), \
            ...
            mock_parse.return_value = [
                Entry(id_="entry3", lexical_unit={"en": "application"}, senses=[Sense(id="sense_1", definitions={"en": {"text": "a program"}})]),
                Entry(id_="entry1", lexical_unit={"en": "apple"}, senses=[Sense(id="sense_1", definitions={"en": {"text": "a fruit"}})])
            ]
            entries, total = service.list_entries(limit=10, offset=0, sort_by="lexical_unit", sort_order="desc", filter_text="app")
            assert len(entries) == 2
            assert total == 2
    ...
    def test_list_entries_backward_compatibility(self) -> None:
        ...
        with patch.object(service, 'count_entries', return_value=1), \
            ...
            mock_parse.return_value = [
                Entry(id_="entry1", lexical_unit={"en": "test"}, senses=[Sense(id="sense_1", definitions={"en": {"text": "a test word"}})])
            ]
