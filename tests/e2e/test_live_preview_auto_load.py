...
def test_live_preview_auto_load_with_debug(page: Page, flask_test_server):
  ...
  <sense id="s1"><definition><form lang="en"><text>test</text></form></definition></sense>
    ...
    requests.post(f"{base_url}/api/xml/entries", data=lift_xml.encode('utf-8'), headers={'Content-Type': 'application/xml'})
...
def test_live_preview_refresh_button(page: Page, flask_test_server):
