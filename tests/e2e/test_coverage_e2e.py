...
def test_coverage_page_loads(page: Page, app_url: str) -> None:
    ...
    expect(page.locator("text=Resource Coverage")).to_be_visible()
    expect(page.locator("text=Text Coverage")).to_be_visible()
    expect(page.locator("text=Systematicity")).to_be_visible()
    expect(page.locator("text=Sense Alignment")).to_be_visible()
    expect(page.locator("text=WordNet Lookup")).to_be_visible()
...
def test_wordnet_lookup(page: Page, app_url: str) -> None:
    ...
    page.click("text=WordNet Lookup")
    ...
    expect(page.locator("#wordnet-results-body .list-group-item")).to_have_count(
        greater_than=0
    )
...
def test_text_coverage(page: Page, app_url: str) -> None:
    ...
    expect(page.locator("#text-table-body tr")).to_have_count(greater_than=0)
...
def test_resource_coverage_upload(page: Page, app_url: str, tmp_path) -> None:
    ...
    # Should show entries
    expect(page.locator("#resource-table-body tr")).to_have_count(greater_than=0)
...
def test_sense_alignment_tab(page: Page, app_url: str) -> None:
    ...
    page.click("text=Sense Alignment")
