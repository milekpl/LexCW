...
# Use shared `client` fixture from tests/integration/conftest.py to ensure session/project is set consistently
# (removed local client fixture to keep tests DRY)
