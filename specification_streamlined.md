# Lexicographic Curation Workbench (LCW) Specification v2.0 - Streamlined
...
The following UI components use dynamic ranges and project settings:
...
- XML Namespace Handling Improvement 
...
- API Ecosystem
- WordNet Integration
- Constrast and Compare with Other Sources
