...
class XQueryBuilder:
    ...
    @staticmethod
    def build_entry_by_id_query(entry_id: str, db_name: str, has_namespace: bool = True) -> str:
        """
    ...
    @staticmethod
    def build_all_entries_query(db_name: str, has_namespace: bool = True, 
    ...
    @staticmethod
    def build_search_query(search_term: str, db_name: str, has_namespace: bool = True,
                          limit: Optional[int] = None, offset: Optional[int] = None) -> str:
        """
    ...
    @staticmethod
    def build_count_entries_query(db_name: str, has_namespace: bool = True, 
    ...
    @staticmethod
    def build_insert_entry_query(entry_xml: str, db_name: str, has_namespace: bool = True) -> str:
        """
    ...
    @staticmethod
    def build_update_entry_query(entry_id: str, entry_xml: str, db_name: str, 
                                has_namespace: bool = True) -> str:
        """
    ...
    @staticmethod
    def build_delete_entry_query(entry_id: str, db_name: str, has_namespace: bool = True) -> str:
        """
    ...
    @staticmethod
    def build_advanced_search_query(criteria: Dict[str, Any], db_name: str, 
        ...
        if 'lexical_unit' in criteria:
            lexical_unit_path = XQueryBuilder.get_element_path("lexical-unit", has_namespace)
            conditions.append(f"contains($entry//{lexical_unit_path}, \"{criteria['lexical_unit']}\")")
        
        if 'sense_gloss' in criteria:
            gloss_path = XQueryBuilder.get_element_path("gloss", has_namespace)
            conditions.append(f"contains($entry//{gloss_path}, \"{criteria['sense_gloss']}\")")
        
        if 'grammatical_info' in criteria:
            grammatical_info_path = XQueryBuilder.get_element_path("grammatical-info", has_namespace)
            conditions.append(f"$entry//{grammatical_info_path}[@value=\"{criteria['grammatical_info']}\"]")
        
        if 'example_text' in criteria:
            example_path = XQueryBuilder.get_element_path("example", has_namespace)
            conditions.append(f"contains($entry//{example_path}, \"{criteria['example_text']}\")")
    ...
    @staticmethod
    def build_range_query(range_name: str, db_name: str, has_namespace: bool = True) -> str:
        """
